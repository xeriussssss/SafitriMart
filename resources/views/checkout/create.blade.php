...
@section('content')
    ...
    <nav class="container py-3 bg-light">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('keranjang.index') }}" class="text-decoration-none">Keranjang</a>
            </li>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_pembeli') is-invalid @enderror"
                                        name="nama_pembeli" value="{{ old('nama_pembeli', auth()->user()->nama) }}"
                                        required>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-3" id="kurir-section" style="display:none;">
                                    ...
                                    <div class="d-flex gap-2 flex-wrap" id="kurir-list">
                                        @foreach(['jne' => 'JNE', 'pos' => 'POS Indonesia', 'tiki' => 'TIKI', 'sicepat' => 'SiCepat'] as $kode => $nama)
                                ...
                                <div id="payment-detail-qris" class="mt-3" style="display:none;">
                                    @if(!empty($qrisQrImage))
                                        <div class="text-center bg-white p-3 rounded-3 border">
                                            <img src="{{ Storage::disk('public')->url($qrisQrImage) }}" alt="QR QRIS"
                                    ...
                                    @foreach($bankAccounts as $bank)
                                        <div class="card border-0 bg-light mb-2">
                                            <div class="card-body p-3">
                                                ...
                                                <p class="mb-0 fw-bold font-monospace">{{ $bank['account_number'] }}</p>
                                ...
                                <div id="dana-nomor-hp-section" class="mt-3" style="display:none;">
                                    <div class="card border-0 bg-light">
                                        <div class="card-body p-3 text-center">
                                            <p class="fw-bold fs-5 font-monospace mb-1">{{ $danaPhone }}</p>
                                            <p class="text-muted small mb-0">a.n. {{ $danaName }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="dana-qr-code-section" class="mt-3" style="display:none;">
                                    @if(!empty($danaQrImage))
                                        <div class="text-center">
                                            <img src="{{ Storage::disk('public')->url($danaQrImage) }}" alt="QR DANA"
                                                class="img-fluid rounded" style="max-width:200px;">
                                        </div>
                                    @endif
                                </div>
...
@push('scripts')
    <script>
        ...
        function hitungOngkir() {
            ...
            const totalBerat = {{ $items->sum('jumlah') }} * 500;
