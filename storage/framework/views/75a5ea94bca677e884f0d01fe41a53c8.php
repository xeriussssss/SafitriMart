...
<?php $__env->startSection('content'); ?>
    ...
    <nav class="container py-3 bg-light">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('pesanan.index')); ?>" class="text-decoration-none">Pesanan Saya</a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8">
                    ...
                    <div id="order-info" class="card border-0 shadow-sm mt-4" style="display:none;">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-semibold font-monospace"><?php echo e($transaksi->midtrans_order_id); ?></span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span class="text-muted">Nama</span>
                                <span class="fw-semibold"><?php echo e($transaksi->nama_pembeli); ?></span>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaksi->kurir): ?>
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-muted">Pengiriman</span>
                                    <span class="fw-semibold"><?php echo e(strtoupper($transaksi->kurir)); ?> - <?php echo e(strtoupper($transaksi->layanan_kurir ?? '')); ?></span>
                                </div>
                    ...
                    <div id="pay-button-container" class="mt-3" style="display:none;">
                        ...
                        <a href="<?php echo e(route('pesanan.index')); ?>" class="btn btn-outline-secondary w-100 mt-2">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(config('midtrans.snap_url')); ?>"
            data-client-key="<?php echo e(config('midtrans.client_key')); ?>"></script>

    <script>
        const snapToken = <?php echo json_encode($snapToken, 15, 512) ?>;
        const finishUrl = <?php echo json_encode(route('pesanan.show', $transaksi->id), 512) ?>;
        const pesananUrl = <?php echo json_encode(route('pesanan.index'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\AutoCommerce-LaravelCloud\AutoCommerce-main\resources\views/checkout/midtrans.blade.php ENDPATH**/ ?>