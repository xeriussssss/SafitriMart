        ...
        <div class="container">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pesanan->isEmpty()): ?>
                ...
                <div class="empty-state text-center py-5" data-aos="fade-up">
                    ...
                    <a href="<?php echo e(route('katalog')); ?>" class="btn btn-primary btn-lg px-5">
                    ...
                    <div class="col-lg-10">
                        <div class="accordion order-accordion" id="ordersAccordion">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pesanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="order-card mb-4" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 60); ?>">
                                    ...
                                    <div class="order-header d-flex align-items-center gap-2 flex-wrap" data-bs-toggle="collapse"
                                        ...
                                        aria-expanded="<?php echo e($loop->first ? 'true' : 'false'); ?>" role="button">

                                        <div class="order-id">
                                            <i class="bi bi-hash"></i>TRX<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?>
                                    ...
                                    <div class="order-actions">
                                        <a href="<?php echo e(route('pesanan.show', $order)); ?>" class="btn-action btn-action-view"
                                            title="Lihat Detail">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->status === 'pending'): ?>
                                            <form action="<?php echo e(route('pesanan.cancel', $order)); ?>" method="POST" class="d-inline"
                                    ...
                                    <!-- Collapsible Body -->
                                    <div id="collapse<?php echo e($order->id); ?>" class="collapse <?php echo e($loop->first ? 'show' : ''); ?>">
                                                ...
                                                <div class="col-sm-6 col-md-4">
                                                    <div class="info-card">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="info-card-value"><?php echo e($order->alamat); ?></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-12 col-md-4">
                                                    <div class="info-card">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="info-card-value"><?php echo e($order->nama_pembeli); ?></div>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->no_telepon): ?>
                                                                <div class="info-card-sub">
                                                                    <i class="bi bi-telephone me-1"></i><?php echo e($order->no_telepon); ?>

                                                                </div>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                            <div class="info-card-sub"><?php echo e($order->user->email); ?></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <table class="table order-table mb-0">
                                                        ...
                                                        <tbody>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $order->detailTransaksi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    <td>
                                                                        <span class="fw-semibold"><?php echo e($detail->nama_produk); ?></span>
                                                                    </td>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <span class="qty-badge"><?php echo e($detail->jumlah); ?></span>
                                                                    </td>
                                                            ...
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($order->diskon_voucher > 0): ?>
                                                                <tr class="summary-row">
                                                                    ...
                                                                    <td class="text-end text-success fw-semibold">
                                                                        - Rp <?php echo e(number_format($order->diskon_voucher, 0, ',', '.')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\AutoCommerce-LaravelCloud\AutoCommerce-main\resources\views/pesanan/index.blade.php ENDPATH**/ ?>