...
<nav class="container py-3 bg-light">
    <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('katalog')); ?>" class="text-decoration-none">Katalog</a></li>
        ...
        <li class="breadcrumb-item">
            <a href="<?php echo e(route('katalog', ['kategori' => $produk->kategori_id])); ?>" class="text-decoration-none">
                <?php echo e($produk->kategori->nama); ?>

            </a>
        </li>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <li class="breadcrumb-item active"><?php echo e(Str::limit($produk->nama, 30)); ?></li>
    </ol>
</nav>
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="mb-3">
                    ...
                    <a href="<?php echo e(route('katalog', ['kategori' => $produk->kategori_id])); ?>"
                        ...
                        <i class="bi bi-tag me-1"></i><?php echo e($produk->kategori->nama); ?>
                ...
                <h1 class="display-5 fw-bold mb-3 product-detail-title"><?php echo e($produk->nama); ?></h1>
                ...
                <form action="<?php echo e(route('keranjang.tambah', $produk)); ?>" method="POST" class="mb-4">
                    <?php echo csrf_field(); ?>
                    <div class="row g-3 align-items-stretch">
                        <div class="col-auto">
                            ...
                            <div class="input-group quantity-group">
                                ...
                                <input type="number" name="jumlah" id="quantity" class="form-control text-center qty-detail"
                                    value="1" min="1" max="<?php echo e($produk->stok); ?>" style="width: 80px;">
                        ...
                        <div class="col">
                            ...
                            <button type="submit" class="btn btn-cart-detail btn-lg w-100"
                                ...
                                <i class="bi bi-cart-plus me-2"></i><?php echo e($produk->stok > 0 ? 'Tambah ke Keranjang' : 'Stok Habis'); ?>
                ...
                <?php else: ?>
                <div class="mb-4">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-cart-detail btn-lg w-100">
                ...
                <div class="mb-4">
                    ...
                    <div class="text-muted">
                        <?php echo nl2br(e($produk->deskripsi ?? 'Deskripsi produk belum tersedia.')); ?>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo e($produk->kategori->nama ?? 'Umum'); ?></td>
                            </tr>
                            <tr>
                                <th class="bg-light">Stok Tersedia</th>
                                <td>
                                    <span class="badge <?php echo e($produk->stok > 0 ? 'bg-success' : 'bg-danger'); ?>">
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($produk->review_count > 0): ?>
        <div class="row mb-4" data-aos="fade-up">
            <div class="col-md-4">
                <div class="bg-white rounded-3 p-4 shadow-sm text-center">
                    <div class="display-4 fw-bold text-warning"><?php echo e(number_format($produk->rating, 1)); ?></div>
                    <div class="mb-2">
                    ...
                    <small class="text-muted"><?php echo e($produk->review_count); ?> ulasan</small>
                </div>
            </div>
            <div class="col-md-8">
                <div class="bg-white rounded-3 p-4 shadow-sm">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-2">
                        <span class="small fw-semibold" style="width: 20px;"><?php echo e($star); ?></span>
        ...
        <div class="bg-white rounded-3 p-4 shadow-sm" data-aos="fade-up">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $produk->reviews->sortByDesc('created_at')->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="border-bottom pb-3 mb-3 <?php echo e(!$loop->last ? '' : 'border-0'); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($review->komentar): ?>
                <p class="text-muted small mb-0">"<?php echo e($review->komentar); ?>"</p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
            <?php
                $relatedProducts = \App\Models\Produk::where('kategori_id', $produk->kategori_id)
                    ...
                    ->get();
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col d-flex" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                <div class="product-card rounded-3 overflow-hidden border-0 shadow-sm bg-white d-flex flex-column w-100 h-100">
                    <figure class="product-figure mb-0 position-relative overflow-hidden">
                        <a href="<?php echo e(route('produk.show', $related)); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($related->gambar): ?>
                            <img src="<?php echo e($related->imageUrl()); ?>" alt="<?php echo e($related->nama); ?>"
                    ...
                    <div class="product-info p-3 d-flex flex-column flex-grow-1">
                        <small class="text-primary text-uppercase fw-semibold mb-1"><?php echo e($related->kategori->nama ?? 'Umum'); ?></small>
                        <a href="<?php echo e(route('produk.show', $related)); ?>" class="text-decoration-none mb-2">
                            <h6 class="fw-bold mb-0 text-dark product-title"><?php echo e($related->nama); ?></h6>
                        </a>
                        <span class="fs-5 fw-bold text-primary mb-3">Rp <?php echo e(number_format($related->harga, 0, ',', '.')); ?></span>
                        <div class="mt-auto product-actions">
                            <a href="<?php echo e(route('produk.show', $related)); ?>" class="btn btn-detail w-100">
...
<link href="<?php echo e(asset('css/produk-detail.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\AutoCommerce-LaravelCloud\AutoCommerce-main\resources\views/katalog/show.blade.php ENDPATH**/ ?>